...
class brandsController extends Controller
{
    ...
    public function list(){
        ...
        $sec = Brands::where('user_id','=',Auth::id())->get();
    ...
    public function sil($id){
        $check = Brands::join('products','products.brand_id','brands.id')->where('brands.user_id','=',Auth::id())->count();
        if($check == 0){
            $con = Brands::find($id)->delete();
            return redirect()-> route('blist')->with('delete','Brand is deleted!');
        }
        return redirect()->route('blist')->with('delete','There is product of this brand in the storage');
    }
