...
class ordersController extends Controller
{
    public function add(ordersRequest $orders){
        ...
        return redirect()->route('orlist')->with('success','Order successfully added');
    } 

    public function list(){
        $say = Orders::where('user_id',Auth::id())->count();    
    ...
    public function sil($id){
        ...
        return redirect()->route('orlist')->with('delete','Order successfully deleted');
    }
    ...
    public function update(ordersRequest $orders){
        ...
        return redirect()->route('orlist')->with('update','Order successfully updated');
    }
    ...
    public function confirm($id){
        ...
        if($oamount<=$pamount)
        {
            ...
            return redirect()->route('orlist')->with('success','Order successfully confirmed');

        }

        return redirect()->route('orlist')->with('delete','There is no enough product to confirm this order');
    }
    ...
    public function cancel($id){
        ...
        $pcon = Products::find($ocon->product_id);
            ...
            return redirect()->route('orlist')->with('cancel','Order canceled');
