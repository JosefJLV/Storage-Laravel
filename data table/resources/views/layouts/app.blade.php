        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first" style="font-size:18px;"><b>Menu</b></li>
                    <!-- <li><a href="index.html"><i class="icon icon-single-04"></i><span class="nav-text">Dashboard</span></a>
                    </li> -->

                    <li><a href="{{route('blist')}}"><i
                                class="icon icon-world-2"></i><span class="nav-text">Brands</span></a>
                    </li>

                    <li><a href="{{route('clist')}}"><i
                                class="icon icon-single-04"></i><span class="nav-text">Clients</span></a>
                        
                    </li>
                    
                    <li><a href="{{route('plist')}}"><i
                                class="icon icon-form"></i><span class="nav-text">Products</span></a>
                    </li>
                    
                    <li><a href="{{route('orlist')}}"><i
                                class="icon icon-layout-25"></i><span class="nav-text">Orders</span></a>
                    </li>

                    <li><a href="{{route('elist')}}"><i
                                class="icon icon-chart-bar-33"></i><span class="nav-text">Expenses</span></a>   
                    </li>
