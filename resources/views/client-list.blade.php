          ...
          <div class="modal-body">
            <form action="javascript:void(0)" id="addEditBookForm" name="addEditBookForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="title" name="name" placeholder="Enter Client's Name" maxlength="50" required="">
                </div>
              </div> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="surname" name="surname" placeholder="Enter Client's surname" maxlength="50" required="">
                </div>
              </div> 

              <div class="form-group">
                <label for="name" class="col-sm-2 control-label"><b>Phone</b></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="code" name="phone" placeholder="Enter Client's Number" maxlength="50" required="">
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label"><b>Company</b></label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="author" name="company" placeholder="Enter Company Name" required="">
                </div>
              </div>             
              ...
              <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-primary" id="btn-save" value="addNewBook">Add Client 
                </button>
              </div>
            </form>
          </div>
    ...
    $('body').on('click', '.edit', function () {
        ...
        $.ajax({
            ...
            success: function(res){
              $('#ajaxBookModel').html("Edit client");
              $('#ajax-book-model').modal('show');
              $('#id').val(res.id);
              $('#title').val(res.name);
              $('#surname').val(res.surname);
              $('#code').val(res.phone);
              $('#author').val(res.company);
